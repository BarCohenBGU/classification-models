function [response, Accuracy, Precision, Recall, F1, classificationEnsemble,validationPredictions,validationAccuracy, validationAccuracy2, partitionedModel,validationScores] = Ensemble (trainingData)
