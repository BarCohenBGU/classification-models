function  [response, Accuracy, Precision, Recall, F1, classificationTree,validationPredictions,validationAccuracy, validationAccuracy2, partitionedModel,validationScores] = DecisionTree(trainingData)
