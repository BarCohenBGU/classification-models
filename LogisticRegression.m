function [response, Accuracy, Precision, Recall, F1, GeneralizedLinearModel,validationPredictions,validationAccuracy,validationScores] = LogisticRegression (trainingData)
