function [response, Accuracy, Precision, Recall, F1, classificationNaiveBayes,validationPredictions,validationAccuracy, validationAccuracy2, partitionedModel,validationScores] = NB (trainingData)
